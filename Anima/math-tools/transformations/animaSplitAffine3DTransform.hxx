...
::ComputeMatrix()
{
    ...
    vnl_matrix <TScalarType> firstRotationMatrix(InputSpaceDimension,InputSpaceDimension);
    ...
    vnl_matrix <TScalarType> secondRotationMatrix(InputSpaceDimension,InputSpaceDimension);
