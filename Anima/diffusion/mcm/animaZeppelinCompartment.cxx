...
void ZeppelinCompartment::GetRandomlySampledDirection(std::mt19937 &random_generator, Vector3DType &sample)
{
...
double ZeppelinCompartment::GetAlongDirectionDiffusionProfileIntegralLogarithm(Vector3DType &direction)
{
    // Ensure diffusion tensor is computed
    this->GetDiffusionTensor();
